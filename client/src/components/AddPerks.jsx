...
export default function AddPerks({selected, onChange}){
    ...
    return(
        <>
            <div className="add-perks">
                ...
                <label>
                    <input type="checkbox" checked={selected.includes('electricity')} name="electricity" onChange={handleCheckBoxClick}/>
                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-6 h-6">
                ...
                <label>
                    <input type="checkbox" checked={selected.includes('fire')} name="fire" onChange={handleCheckBoxClick}/>
                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-6 h-6">
